              ...
              <div style={{
                ...
                {leftSidebarTab === 'layout' && (
                  <>
                    ...
                    ) : selectedScreen !== null && screens[selectedScreen]?.aiGenerated ? (
                      <div style={{
                        display: 'flex',
                        flexDirection: 'column',
                        alignItems: 'center',
                        ...
                        <Text variant="muted" size="sm" style={{ maxWidth: '250px' }}>
                          This screen was generated by AI. Use the AI Chat tab to regenerate or modify it.
                        </Text>
                        <Button
                          onClick={() => setLeftSidebarTab('ai-builder')}
                          style={{
        ...
        elements: [
          {
            ...
            props: {},
            children: [
              // Hero section with ZStack for layered card
              {
                id: `zstack_${Date.now()}`,
                type: 'zstack',
                style: {
                ...
                children: [
                  // Background gradient
                  {
                    ...
                    props: {},
                    position: { type: 'absolute', top: 0, left: 0, zIndex: 0 },
                  },
                  ...
                  // Centered content
                  {
                    ...
                    props: {},
                    position: { type: 'absolute', centerX: true, centerY: true, zIndex: 2 },
                    children: [
                      {
                      ...
                      },
                      {
                        ...
                        props: {
                          text: 'Experience beautiful layered layouts',
                        },
                      },
                    ],
                  },
                  // Badge in top-right corner
                  {
                    ...
                    props: {},
                    position: { type: 'absolute', top: 16, right: 16, zIndex: 3 },
                    children: [
                      {
                        id: `badge_text_${Date.now()}`,
                        type: 'text',
                        style: {
                          fontSize: 12,
                          fontWeight: '600',
              ...
              // Description text
              {
                ...
                props: {
                  text: 'Build custom onboarding screens with layered elements using ZStack',
                },
              },
              // Bottom button
              {
