...
export function RadioPropertiesPanel({ element, onUpdate }: RadioPropertiesPanelProps) {
  ...
  return (
    <div style={{
      ...
      <Section title="Content" icon="📝">
        <Property label="Selected Color">
          <ColorInput
            value={props.color || '#10b981'}
        ...
        <Property label="Options">
          <div style={{
            ...
            {props.options && props.options.length > 0
              ? `${props.options.length} option(s) configured`
