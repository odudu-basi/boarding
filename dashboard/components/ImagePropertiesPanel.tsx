...
export function ImagePropertiesPanel({ element, onUpdate }: ImagePropertiesPanelProps) {
  ...
  const getPaddingValue = (side: 'top' | 'bottom' | 'left' | 'right') => {
    ...
    <div style={{
      ...
      <Section title="Layer" icon="◧">
        ...
        <Property label="Hidden">
          <Select
            value={style.hidden ? 'true' : 'false'}
            onChange={(value) => updateStyle({ hidden: value === 'true' })}
            options={[
      ...
      <Section title="Size" icon="□">
          ...
          <TextInput
            ...
            onChange={(value) => {
              if (!value) {
                ...
                updateStyle({ width: parseFloat(value) || undefined })
              }
            }}
            placeholder="auto"
            unit="px"
          ...
          <TextInput
            ...
            onChange={(value) => {
              if (!value) {
                ...
                updateStyle({ height: value })
              } else {
                updateStyle({ height: parseFloat(value) || undefined })
              }
            }}
            placeholder="auto"
            unit="px"
        ...
        <Property label="Max Width">
          <TextInput
            value={style.maxWidth?.toString() || ''}
            onChange={(value) => updateStyle({ maxWidth: value ? parseInt(value) : undefined })}
            placeholder="—"
            unit="px"
          />
        </Property>

        <Property label="Max Height">
          <TextInput
            value={style.maxHeight?.toString() || ''}
            onChange={(value) => updateStyle({ maxHeight: value ? parseInt(value) : undefined })}
            placeholder="—"
            unit="px"
          />
        </Property>
      ...
      <Section title="Padding" icon="⊞">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: theme.spacing.sm }}>
          <Property label="Top">
            <TextInput
              value={getPaddingValue('top').toString()}
              onChange={(value) => setPadding('top', parseInt(value) || 0)}
              unit="px"
            />
          </Property>
          ...
          <Property label="Bottom">
            <TextInput
              value={getPaddingValue('bottom').toString()}
              onChange={(value) => setPadding('bottom', parseInt(value) || 0)}
              unit="px"
            />
          </Property>
          ...
          <Property label="Left">
            <TextInput
              value={getPaddingValue('left').toString()}
              onChange={(value) => setPadding('left', parseInt(value) || 0)}
              unit="px"
            />
          </Property>
          ...
          <Property label="Right">
            <TextInput
              value={getPaddingValue('right').toString()}
              onChange={(value) => setPadding('right', parseInt(value) || 0)}
              unit="px"
            />
          </Property>
        </div>
      ...
      <Section title="Position" icon="∴">
        <Property label="Type">
          <Select
            ...
            onChange={(value) => onUpdate({
              position: { ...element.position, type: value as any }
            })}
            options={[
        ...
        <Property label="Z-Index">
          <TextInput
            ...
            onChange={(value) => onUpdate({
              position: { ...element.position, zIndex: parseInt(value) || undefined }
            })}
            placeholder="auto"
          />
        </Property>
