...
export function TextPropertiesPanel({ element, onUpdate }: TextPropertiesPanelProps) {
  ...
  // Local state for text content to avoid re-render issues on every keystroke
  const [localText, setLocalText] = useState(props.text || '')

  // Sync local text when the element changes (e.g., selecting a different element)
  useEffect(() => {
      ...
      <Section title="Typography" icon="Aa">
        ...
        <Property label="Font Weight">
          <Select
            ...
            onChange={(value) => updateStyle({ fontWeight: value as any })}
            options={[
        ...
        <Property label="Line Height">
          <NumberInput
            value={style.lineHeight !== undefined ? style.lineHeight * 100 : 150}
            onChange={(value) => updateStyle({ lineHeight: value / 100 })}
            unit="%"
            min={80}
            max={300}
          />
        ...
        <Property label="Text Align">
          <Select
            ...
            onChange={(value) => updateStyle({ textAlign: value as any })}
            options={[
        ...
        <Property label="Text Transform">
          <Select
            value={style.textTransform || 'none'}
            onChange={(value) => updateStyle({ textTransform: value as any })}
            options={[
        ...
        <Property label="Text Decoration">
          <Select
            value={style.textDecoration || 'none'}
            onChange={(value) => updateStyle({ textDecoration: value as any })}
            options={[
              { value: 'none', label: 'None' },
      ...
      <Section title="Size" icon="□">
        ...
        <Property label="Max Width">
          <TextInput
            ...
            onChange={(value) => updateStyle({ maxWidth: parseInt(value) || undefined })}
            placeholder="—"
            unit="px"
          />
        </Property>
