...
export function SliderPropertiesPanel({ element, onUpdate }: SliderPropertiesPanelProps) {
  ...
  return (
    <div style={{
      ...
      <Section title="Content" icon="📝">
        ...
        <Property label="Min Value">
          <TextInput
            value={props.min?.toString() || '0'}
            onChange={(value) => updateProp('min', parseInt(value) || 0)}
          />
        </Property>

        <Property label="Max Value">
          <TextInput
            value={props.max?.toString() || '100'}
            onChange={(value) => updateProp('max', parseInt(value) || 100)}
          />
        </Property>

        <Property label="Step">
          <TextInput
            value={props.step?.toString() || '1'}
            onChange={(value) => updateProp('step', parseInt(value) || 1)}
          />
        </Property>

        <Property label="Current Value">
          <TextInput
            value={props.value?.toString() || '50'}
            onChange={(value) => updateProp('value', parseInt(value) || 50)}
          />
        </Property>

        <Property label="Show Value">
          <Select
            value={props.showValue ? 'true' : 'false'}
            onChange={(value) => updateProp('showValue', value === 'true')}
            options={[
        ...
        <Property label="Accent Color">
          <ColorInput
            value={props.color || theme.colors.primary}
