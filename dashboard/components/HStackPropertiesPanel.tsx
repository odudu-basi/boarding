...
interface HStackPropertiesPanelProps {
  element: Element
  onUpdate: (updates: Partial<Element>) => void
  flowTheme?: FlowTheme
}

export function HStackPropertiesPanel({ element, onUpdate, flowTheme }: HStackPropertiesPanelProps) {
  ...
  return (
    <div style={{
      ...
      {/* Stack Section - HStack specific */}
      <Section title="Stack" icon="▦">
        <Property label="Axis">
          <Select
            value={style.flexDirection || 'row'}
            onChange={(value) => updateStyle({ flexDirection: value as 'row' | 'column' })}
            options={[
        ...
        <Property label="Horizontal">
          <Select
            ...
            onChange={(value) => updateStyle({ justifyContent: value as any })}
            options={[
        ...
        <Property label="Vertical">
          <Select
            ...
            onChange={(value) => updateStyle({ alignItems: value as any })}
            options={[
        ...
        <Property label="Wrap">
          <Select
            value={style.wrap ? 'wrap' : 'nowrap'}
            onChange={(value) => updateStyle({ wrap: value === 'wrap' })}
            options={[
        ...
        <Property label="Scroll">
          <Select
            value={style.scroll ? 'scroll' : 'noscroll'}
            onChange={(value) => updateStyle({ scroll: value === 'scroll' })}
            options={[
              { value: 'noscroll', label: 'No Scroll' },
      ...
      {/* All other sections are the same as VStack */}
      {/* Layer Section */}
...
// Shared UI Components (same as VStackPropertiesPanel)
